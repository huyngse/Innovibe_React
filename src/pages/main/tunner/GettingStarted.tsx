    ...
    <section className="py-5">
      ...
      <div className="grid grid-cols-3 gap-10 py-5">
        <div>
            ...
            <h3 className="font-bold text-center">Tuning Tip #1: Start With Standard</h3>
        ...
        <div>
            ...
            <h3 className="font-bold text-center">Tuning Tip #2: Pick & Pluck</h3>
        ...
        <div>
            ...
            <h3 className="font-bold text-center">Tuning Tip #3: Sharp vs. Flat</h3>
