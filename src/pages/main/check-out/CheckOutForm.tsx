  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-12 gap-3 py-3">
        ...
        <Input placeholder="Phone Number" className="py-6 col-span-6"></Input>
        ...
        <Input
          ...
          className="py-6 col-span-12"
        ></Input>
        <Input placeholder="City/Province" className="py-6 col-span-4"></Input>
